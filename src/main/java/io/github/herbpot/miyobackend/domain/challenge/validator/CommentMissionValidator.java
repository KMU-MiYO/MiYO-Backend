...
public class CommentMissionValidator implements MissionValidator {
    ...
    public void validateAndUpdateProgress(String userId, Long relatedId) {
        log.info("Validating comment mission for userId: {}, contestPostId: {}", userId, relatedId);
        ...
        for (Mission mission : activeMissions) {
            ...
            log.info("Updated comment mission progress: missionId={}, userId={}, currentCount={}/{}, completed={}",

...
/**
 * EmpathyReadModel Entity (Read DB)
 * - 게시글 공감 데이터 읽기 전용 모델
 * - 한 사용자가 한 게시글에 하나의 공감만 가능
 * - userId + postId 복합키
 * - Redis Pub/Sub을 통해 Write DB에서 동기화됨
 */
@Entity
...
public class EmpathyReadModel {
    ...
    @Builder
    public EmpathyReadModel(Long empathyId, String userId, Long postId, LocalDateTime createdAt) {
